...
public class LoopableBackground implements Positioning{
	...
	public double getPositionX() {
		...
		if(background[0].getPositionX() > background[1].getPositionX()) {
			return background[1].getPositionX();
		} else {
			return background[0].getPositionX();
		}
	}

	public double getPositionY() {
		System.out.println(Arrays.toString(background));
		if(background[0].getPositionY() > background[1].getPositionY()) {
			return background[1].getPositionY();
		} else {
			return background[0].getPositionY();
		}
	}

	public double getVelocityX() {
		return background[0].getVelocityX();
	}

	public double getVelocityY() {
		return background[0].getVelocityY();
	}
}
